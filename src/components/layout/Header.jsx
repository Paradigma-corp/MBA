...
const Header = () => (
  <header className="flex flex-wrap items-center justify-between gap-4">
    <div className="space-y-2">
      <p className="text-[11px] uppercase tracking-[0.18em] text-slate-500">Panel ejecutivo</p>
      <h1 className="text-3xl font-semibold text-slate-900">Suite de analítica integrada</h1>
